...
MarvBot.prototype._welcomeMessage = function () {
    this.postMessageToChannel(this.channels[0].name, 'Hi guys, roundhouse-kick anyone?' +
        '\n I can tell jokes, but very honest ones. Just say `Marvbot` or `' + this.name + '` to invoke me!',
        {as_user: true});
};
...
MarvBot.prototype._replyWithRandomJoke = function (originalMessage) {
    var self = this;
